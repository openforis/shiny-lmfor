...
plot_estimates <- function(treedata, col_index, modelname, var_type, var_name, Max_values) {
  ...
  # stat_treedata <- treedata %>% 
  #   count(!!as.symbol(var_name))
  # #print(str( stat_treedata ))
  # 
  # treedata <- treedata %>% left_join(stat_treedata, by= var_name) 
  # rm(stat_treedata)
  # treedata1 <- subset(treedata, n < 4)
  # treedata2 <- subset(treedata, n >= 4)
  # 
  # print(paste0("treedata1: ", nrow(treedata1)))
  # print(paste0("treedata2: ", nrow(treedata2)))
  
  # https://stackoverflow.com/questions/52695969/ggplot-fails-to-draw-smooth-gam-using-facet-wrap-and-group-asthetic
  # https://ggplot2.tidyverse.org/reference/geom_smooth.html
  # myos https://stackoverflow.com/questions/43987989/r-adding-layers-to-a-ggplot-plot-with-vectors-of-different-length
